...
void UAbilityDebugFunctionLibrary::PrintAttribute(
	...
	if (!AbilitySystem)
	{
		UE_LOGFMT(LogAshenSun, Warning, "[AbilityDebugFunctionLibrary::PrintAttribute]: No valid ability system component.");
		return;
	}

	if (!AbilitySystem->HasAttributeSetForAttribute(Attribute))
	{
		UE_LOGFMT(LogAshenSun, Warning, "[AbilityDebugFunctionLibrary::PrintAttribute]: No attribute selected.");
		return;
	}
...
void UAbilityDebugFunctionLibrary::PrintAllAttributes(
	...
	if (!AbilitySystem)
	{
		UE_LOGFMT(LogAshenSun, Warning, "[AbilityDebugFunctionLibrary::PrintAllAttributes]: No valid ability system component.");
		return;
	}
...
void UAbilityDebugFunctionLibrary::PrintOwnedGameplayTags(
	...
	if (!AbilitySystem)
	{
		UE_LOGFMT(LogAshenSun, Warning, "[AbilityDebugFunctionLibrary::PrintOwnedGameplayTags]: No valid ability system component.");
		return;
	}
